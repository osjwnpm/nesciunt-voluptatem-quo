...
[![npm](https://img.shields.io/npm/v/@osjwnpm/nesciunt-voluptatem-quo.svg)](https://www.npmjs.com/package/@osjwnpm/nesciunt-voluptatem-quo)
[![npm](https://img.shields.io/npm/dm/@osjwnpm/nesciunt-voluptatem-quo.svg?style=flat)](https://www.npmjs.com/package/@osjwnpm/nesciunt-voluptatem-quo)
[![Coverage Status](https://coveralls.io/repos/github/Smoren/@osjwnpm/nesciunt-voluptatem-quo/badge.svg?branch=master&rand=123)](https://coveralls.io/github/Smoren/@osjwnpm/nesciunt-voluptatem-quo?branch=master)
![Build and test](https://github.com/osjwnpm/nesciunt-voluptatem-quo/actions/workflows/test_master.yml/badge.svg)
[![Minified Size](https://badgen.net/bundlephobia/minzip/@osjwnpm/nesciunt-voluptatem-quo)](https://bundlephobia.com/result?p=@osjwnpm/nesciunt-voluptatem-quo)
...
```typescript
import { multi } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { Stream, AsyncStream } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { single } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```bash
npm i @osjwnpm/nesciunt-voluptatem-quo
```
...
```typescript
import { infinite } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { math } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { reduce } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { set } from '@osjwnpm/nesciunt-voluptatem-quo';
...
```typescript
import { summary } from "@osjwnpm/nesciunt-voluptatem-quo";
...
```typescript
import { transform } from "@osjwnpm/nesciunt-voluptatem-quo";
...
```typescript
import { Stream } from "@osjwnpm/nesciunt-voluptatem-quo";
